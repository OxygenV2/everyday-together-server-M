...
After that make sure to only touch these strings(these strings will change ovrtime so be sure to compare the contents of them with the screenshots) <img width="1579" height="783" alt="11Group 11" src="https://github.com/user-attachments/assets/4f20fca8-0ccc-4c19-affe-316983b593b1" /> They contain the actual url needed. Double click them and change the URL to https://oxygenv2.github.io/everyday-together-server-M/p/ or your custom server if you have one.
